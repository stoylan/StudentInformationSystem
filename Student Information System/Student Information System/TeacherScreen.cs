...
namespace Student_Information_System
{
    public partial class TeacherScreen : Form
    {
        ...
        {
            label14.Text = "Date : " + DateTime.Now.ToLongDateString();
            label13.Text = "Time : " + DateTime.Now.ToLongTimeString();
        }

        private void teacher_exitbutton_Click(object sender, EventArgs e)
        {
